    ...
    <Layout>
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-foreground">Ghana Baptist Convention Conference</h1>
        ...
        <Card className="shadow-sm border-primary/10">
          <CardHeader>
            <CardTitle className="text-xl">Welcome to Ghana Baptist Convention Conference System</CardTitle>
            <CardDescription>
